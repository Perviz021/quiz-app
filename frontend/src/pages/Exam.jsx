          ...
          {!state.examStarted ? (
            <div className="ml-4">
              <p className="mb-4 text-lg">
                ...
                İmtahan zamanı qulaqlıq, telefon və digər texniki
                avadanlıqlardan istifadə etmək <br /> 6. Köməkçi
                vasitələr-konspekt, dəftər və s. istifadə etmək <br /> 7.
                İmtahan otağının stol, stul və divarlarına yazı yazmaq <br /> 8.
                Digər tələbə yoldaşına köməyə cəhd etmək <br /> 9. Kompüter
                ekranında digər səhifəni açmağa cəhd etmək <br /> 10. Qaydalara
                riayət etməmək
              </p>
              <button
